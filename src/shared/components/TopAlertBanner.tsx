...
function ClockIcon({ stroke }: { stroke: string }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M12.0078 10.508C11.61 10.508 11.2285 10.666 10.9472 10.9473C10.6658 11.2286 10.5078 11.6102 10.5078 12.008C10.5078 12.4058 10.6658 12.7874 10.9472 13.0687C11.2285 13.35 11.61 13.508 12.0078 13.508C12.4056 13.508 12.7872 13.35 13.0685 13.0687C13.3498 12.7874 13.5078 12.4058 13.5078 12.008C13.5078 11.6102 13.3498 11.2286 13.0685 10.9473C12.7872 10.666 12.4056 10.508 12.0078 10.508ZM12.0078 10.508V7M15.0148 15.02L13.0658 13.072"
        stroke={stroke}
        strokeWidth="1.5"
        strokeLinecap="round"
...
function WarningIcon({ stroke, fill }: { stroke: string; fill: string }) {
  return (
    <svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M10.75 0.749999C5.22715 0.749999 0.750001 5.22715 0.750001 10.75C0.75 16.2728 5.22715 20.75 10.75 20.75C16.2728 20.75 20.75 16.2728 20.75 10.75C20.75 5.22715 16.2728 0.75 10.75 0.749999Z"
        fill={fill}
        stroke={stroke}
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M10.75 6.75L10.75 10.75M10.75 14.75L10.74 14.75"
        stroke={stroke}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function BannerIcon({
  ...
  if (icon === 'warning') return <WarningIcon stroke={stroke} fill={VARIANT[variant].iconFill} />;
