...
export default function SmartBriefingFAB() {
  ...
  return (
    <button onClick={() => navigate('/')} className="group h-16 overflow-hidden max-w-16 hover:max-w-[180px] px-5 bg-black rounded-[12px] flex justify-center items-center fixed bottom-10 right-[30px] z-50 transition-[max-width] duration-300 whitespace-nowrap">
