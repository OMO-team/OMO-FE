...
export default function SmartBriefingFAB() {
  ...
  return (
    <button onClick={() => openChat()} className="group h-16 overflow-hidden max-w-16 hover:max-w-[180px] px-5 bg-black rounded-[12px] flex justify-center items-center fixed bottom-10 right-[70px] z-30 transition-[max-width] duration-300 whitespace-nowrap">
